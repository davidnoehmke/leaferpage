...
export type HomepageImageFragment = Pick<
  StorefrontAPI.Image,
  'id' | 'url' | 'altText' | 'width' | 'height'
>;

export type HomepageMoneyFragment = Pick<
  StorefrontAPI.MoneyV2,
  'amount' | 'currencyCode'
>;
...
> & {
  shortClaim?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  mixingRatio?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
...
export type LeaferHomepageQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type LeaferHomepageQuery = {
  ...
  products: {
    nodes: Array<
      Pick<
        ...
        'id' | 'title' | 'handle' | 'vendor' | 'productType'
      > & {
        shortClaim?: StorefrontAPI.Maybe<
          Pick<StorefrontAPI.Metafield, 'value'>
        >;
        mixingRatio?: StorefrontAPI.Maybe<
          Pick<StorefrontAPI.Metafield, 'value'>
        >;
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  fragment HomepageImage on Image {\n    id\n    url\n    altText\n    width\n    height\n  }\n\n  fragment HomepageMoney on MoneyV2 {\n    amount\n    currencyCode\n  }\n\n  fragment HomepageProduct on Product {\n    id\n    title\n    handle\n    vendor\n    productType\n    shortClaim: metafield(namespace: "leafer", key: "short_claim") {\n      value\n    }\n    mixingRatio: metafield(namespace: "leafer", key: "mixing_ratio") {\n      value\n    }\n    ingredients: metafield(namespace: "leafer", key: "ingredients") {\n      value\n    }\n    featuredImage {\n      ...HomepageImage\n    }\n    selectedOrFirstAvailableVariant {\n      id\n      availableForSale\n      price {\n        ...HomepageMoney\n      }\n      product {\n        title\n        handle\n      }\n    }\n    priceRange {\n      minVariantPrice {\n        ...HomepageMoney\n      }\n    }\n  }\n\n  query LeaferHomepage($country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    shop {\n      name\n      description\n    }\n    products(first: 8, sortKey: UPDATED_AT, reverse: true) {\n      nodes {\n        ...HomepageProduct\n      }\n    }\n    collections(first: 6, sortKey: UPDATED_AT, reverse: true) {\n      nodes {\n        id\n        title\n        handle\n        description\n        image {\n          ...HomepageImage\n        }\n      }\n    }\n  }\n': {
    return: LeaferHomepageQuery;
    variables: LeaferHomepageQueryVariables;
  };
